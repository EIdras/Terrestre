...
public class Movement : MonoBehaviour
{
    ...
    IEnumerator DashWait()
    {
        ...
        // Réactivez la gravité à la fin du dash
        rb.gravityScale = 3;
    ...
    {
        if (coll.onGround && Input.GetAxis("Vertical") < 0) // Si l'axe vertical est négatif, cela signifie que le joueur appuie sur le bouton "down".
        {
